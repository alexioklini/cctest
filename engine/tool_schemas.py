...
TOOL_DEFINITIONS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "(self-contained styled web report, images inlined as base64). The .docx/.pdf/"
