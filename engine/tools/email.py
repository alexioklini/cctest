# Extracted from claude_cli.py — Gmail/email tools
...
# Cross-module deps: CONFIG_PATH, _ok, _err, get_tool_config, AGENTS_DIR,
# _thread_local, _current_agent, _get_artifact_session_folder
