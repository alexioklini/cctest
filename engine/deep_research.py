...
_GRAPHICS_INSTRUCTIONS = (
    ...
    "You may enrich node labels with Font-Awesome icons (`fa:fa-users Team`).\n"
    ...
    "JSON: {\"type\":\"bar\"|\"line\"|\"pie\"|\"funnel\"|\"steps\", \"title\":\"…\", "
    "\"data\":[{\"label\":\"…\",\"value\":<number>,\"icon\":\"rocket\"}, …]}. "
    "pie renders as an infographic donut, funnel as a staged funnel, steps as a "
    "numbered step list (values optional there); `icon` (optional) is a "
    "Font-Awesome-6 solid icon name shown as a badge. Only real numbers from "
    "the sources — never fabricate figures to fill a chart.\n"
