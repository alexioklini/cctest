...
class AdminHandlerMixin(AdminWorkflowHandlers):
    """Mixin with admin/agent/workflow/skills/KG/system handler methods.

    Workflow handlers live in the AdminWorkflowHandlers sub-mixin (extracted to
    handlers/admin_workflows.py); inheriting it keeps the combined
    BrainAgentHandler MRO and all `self.`/global name resolution unchanged.
    """
