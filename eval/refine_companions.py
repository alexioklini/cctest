...
FILES = [
    ...
    f"{ROOT}/20 Datenschutz & Informationssicherheit/.brain-extracted/20_2 Informationssicherheit/20_2_2_4_ARL_Arbeitsplatz Richtlinie.pdf.md",
    ...
    f"{ROOT}/20 Datenschutz & Informationssicherheit/.brain-extracted/20_2 Informationssicherheit/20_2_11 ARL Einsatz von Cloudsystemen.pdf.md",
    f"{ROOT}/20 Datenschutz & Informationssicherheit/.brain-extracted/20_2 Informationssicherheit/20_2_4_1_ARL_Lieferanten und Drittparteien.pdf.md",
]

INSTRUCTION = (
    "Du bereitest ein aus einem PDF konvertiertes Bank-Richtliniendokument "
    "(Markdown) für ein Retrieval-System auf. Gib NUR das aufbereitete Markdown "
    "zurück — keine Vorrede, kein Code-Fence, kein Kommentar.\n\n"
    "REGELN:\n"
    ...
    "3. Strukturiere mit klaren Markdown-Überschriften (## Sektion) und Bullet-Listen, "
    "sodass jede Sektion ein in sich geschlossenes Thema ist.\n"
    "4. Behalte den Dokumenttitel als oberste # Überschrift.\n\n"
    "HIER DAS DOKUMENT:\n\n"
)
