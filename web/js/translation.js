...
// STT-Modell wird zentral unter Einstellungen → Service-Modelle gepflegt
// (Slot „Transkription" + Sprach-Engines) — die früheren per-Tab-Dropdowns
// (trEnsureSttModels) wurden in 9.414.0 auf User-Wunsch entfernt; der Server
// nimmt weiterhin optional `transcribe_model` an, das GUI sendet es nicht mehr.
