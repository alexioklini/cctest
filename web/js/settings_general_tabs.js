        ...
        html += `<div data-model-id="${esc(mid)}">
          ...
          <div id="${detId}" style="display:none;padding:8px 12px;margin:0 0 6px 0;border:1px solid var(--border-100);border-top:none;border-radius:0 0 8px 8px;background:var(--bg-100)">
            ...
            <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(130px,1fr));gap:8px">
              ...
              <div style="display:flex;align-items:center;gap:6px;padding-top:14px"><input type="checkbox" class="mdl-flat-plan" ${cfg.flat_plan === true ? 'checked' : ''} style="margin:0"><label class="form-label" style="font-size:11px;margin:0;cursor:pointer" title="Dieses Modell wird über einen Coding-Plan / eine Flatrate abgerechnet (Z.ai/Kimi Coding Plan, Vibe). Jeder Aufruf wird mit 0 $ realen Kosten verbucht (Quotas, Plan-Verbrauch). Die Kostenfelder links behalten den API-Listenpreis — die Kostenaufstellung zeigt daraus den hypothetischen „API-Listenpreis ohne Flatrate" zur Abschätzung. Cache-Freeze (Kosten cached) bleibt unberührt.">Flatrate / Coding-Plan</label></div>
              <div style="border-left:1px solid var(--border-100);margin:0 -2px"></div>
