        ...
        const emitTools = (tools) => {
          for (const t of tools) {
            ...
            if (t.result !== undefined) {
              ...
              expanded.push({ role: 'tool_result', name: t.name, result: t.result, deanon_result: t.deanon_result || null, tool_round: t.tool_round, tool_use_id: t.tool_use_id || null, _seq: _rSeq, _ts: _rSeq });
              try {
