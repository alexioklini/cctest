...
module.exports = [
  ...
  { ignores: ['eslint.config.js', 'playwright.config.js', 'playwright.brainy.config.js', 'smoke.spec.js', 'termchat.spec.js', 'brainy_helpers.js', 'brainy_context.spec.js', 'brainy_e2e.spec.js', 'brainy_doublesend.spec.js', 'brainy_tone.spec.js', 'node_modules/**'] },
  {
    files: ['**/*.js'],
    languageOptions: {
      ecmaVersion: 2022,
